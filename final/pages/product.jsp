      ...
      <div class="container">
        <div class="row">
          <div class="col-2 p_list" id='gc' onclick="changecolor()">
            <a href="product.jsp" class="select"  onclick="bb(0)">全部遊戲</a>
        ...
        <div class="modal-content">
          <div class="modal-body" >
            <div class="tab">
			  ...
			  <button type="button" class="close mr-3" data-dismiss="modal" style="font-size:30px;padding:0;margin: 10px 10px 0px 0px;">&times;</button>
			  </form>
			  <%
			  }
			  %>
