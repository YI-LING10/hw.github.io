      ...
      <div class="row">
        <div class="col-4" id="content">
          <div style="width: 200px; height:500px; border-right: solid 1px gray;">
            ...
            <a href="backstage01.jsp" class="active" >管理者</a>
        ...
        <div class="col-8">
          <div class="order">
            <h3>管理者瀏覽</h3>
			<input type="submit" name="" value="新增管理員" class="nes-btn is-primary" data-toggle="modal" data-target="#exampleModal">
			
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  <form action="../assets/jsp/b01.jsp" method="post">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">新增管理者</h5>
...
%>
		...
		<input type="hidden" name="page" value="<%=rs.getString("ManagersID")%>" class="form-control">
              <tr>               
                <td><%=rs.getString("ManagersID")%></td>	
                <td><%=rs.getString("ManagersAccount")%></a></td>               
                <td><%=rs.getString("ManagersPassword")%></td>
                <td><%=rs.getString("ManagersPhone")%></td>
				<td><%=rs.getString("ManagersEmail")%></td>
				<td><input type="submit" style="background-color:#00000000; border-style:none;" value="X"></input></td>
				<td><a data-toggle="modal" data-target="#exampleModal1-<%=rs.getString("ManagersID")%>">修改</a></td>
              </tr>
		</form>
		
<!-- Modal1 -->
<div class="modal fade" id="exampleModal1-<%=rs.getString("ManagersID")%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  <form action="../assets/jsp/b01.jsp" method="post">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">修改管理者</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
		...
		<div class="form-group">
			<label for="exampleInputAccount">帳號</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="id"  value="<%=rs.getString("ManagersAccount")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputPassword1">密碼</label>
			<input type="text" class="form-control" id="exampleInputPassword1" name="pwd" value="<%=rs.getString("ManagersPassword")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputTel">電話</label>
			<input type="text" class="form-control" id="exampleInputTel" name="tel" value="<%=rs.getString("ManagersPhone")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">信箱</label>
			<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<%=rs.getString("ManagersEmail")%>">
		</div>
      </div>
      <div class="modal-footer">
