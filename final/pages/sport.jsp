      ...
      <div class="container">
        <div class="row">
          <div class="col-2 p_list" id='gc' onclick="changecolor()">
            ...
            <a href="sport.jsp" class="select" onclick="bb(4)">運動</a>
...
<%
                    //產品顯示
					sql = "SELECT * FROM `product` WHERE `GameClass`='運動'";
          ...
          <div class="modal-body" >
            ...
            <div id="註冊" class="tabcontent">
              <form class="register" action="../assets/jsp/memberadd.jsp" method="post">
                ...
                <span class="ipt2"><input type="email" placeholder="輸入EMAIL" name="email" required ></span>
                <br>
