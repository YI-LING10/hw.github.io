      ...
      <div class="row"">
        <div class="col-4" id="content">
          <div style="width: 200px; height:500px; border-right: solid 1px gray;">
            ...
            <a href="backstage02.jsp" class="active">會員</a>
        ...
        <div class="col-8">
          <div class="order">
            <h3>會員瀏覽</h3>
			<input type="submit" name="" value="新增會員" class="nes-btn is-primary" data-toggle="modal" data-target="#exampleModal" >
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  <form action="../assets/jsp/b02.jsp" method="post">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
			<label for="exampleInputAccount">姓名</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="cname">
		</div>
        <div class="form-group">
			<label for="exampleInputAccount">帳號</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="id">
		</div>
		<div class="form-group">
			<label for="exampleInputPassword">密碼</label>
			<input type="text" class="form-control" id="exampleInputPassword" name="pwd">
		</div>
		<div class="form-group">
			<label for="exampleInputAccount">性別</label>
		...
		<div class="form-group">
			<label for="exampleInputAccount">地址</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="addr">
		</div>
		<div class="form-group">
...
<% 
                    ...
                    String string_page="";
					while(rs.next()){
						string_page=rs.getString("CustomersID");
%>
        <form action="../assets/jsp/b02.jsp" method="post">
		<input type="hidden" name="action" value="delete" class="form-control">
		<input type="hidden" name="page" value="<%=rs.getString("CustomersID")%>" class="form-control">
			  <tr>               
                <td><%=rs.getString("CustomersID")%></td>	
                <td><%=rs.getString("CustomersName")%></a></td>  
				<td><%=rs.getString("CustomersAccount")%></td>	
				<td><%=rs.getString("CustomersPassword")%></td>
                <td><%=rs.getString("CustomersGendre")%></td>
                <td><%=rs.getString("CustomersPhone")%></td>
				<td><%=rs.getString("CustomersAddress")%></td>
				<td><%=rs.getString("CustomersEmail")%></td>
				<td><input type="submit" style="background-color:#00000000; border-style:none;" value="X"></input></td>
				<td><a data-toggle="modal" data-target="#exampleModal1-<%=rs.getString("CustomersID")%>">修改</a></td>
              </tr>
		</form>
<!-- Modal1 -->
<div class="modal fade" id="exampleModal1-<%=rs.getString("CustomersID")%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  <form action="../assets/jsp/b02.jsp" method="post">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">修改會員</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
		...
		<div class="form-group">
			<label for="exampleInputAccount">姓名</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="cname" value="<%=rs.getString("CustomersName")%>">
		</div>
        <div class="form-group">
			<label for="exampleInputAccount">帳號</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="id" value="<%=rs.getString("CustomersAccount")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputPassword">密碼</label>
			<input type="text" class="form-control" id="exampleInputPassword" name="pwd" value="<%=rs.getString("CustomersPassword")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputAccount">性別</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="sex" value="<%=rs.getString("CustomersGendre")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputTel">電話</label>
			<input type="text" class="form-control" id="exampleInputTel" name="tel" value="<%=rs.getString("CustomersPhone")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputAccount">地址</label>
			<input type="text" class="form-control" id="exampleInputAccount" name="addr" value="<%=rs.getString("CustomersAddress")%>">
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">信箱</label>
			<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email" value="<%=rs.getString("CustomersEmail")%>">
		</div>
      </div>
      <div class="modal-footer">
