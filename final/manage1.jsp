				...
				<div class="col-md-10 pr-0 pl-0" style="border: 1px solid black;">
					<div class="tab-content" id="nav-tabContent">
											...
											<div class="modal-body">
												<form>
													<div class="form-group">
														...
														<input type="text" class="form-control" id="exampleInputnumber" name="userNum">
													</div><br>
													<div class="form-group">
														<label for="exampleInputAccount">帳號:</label>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form>
													<div class="form-group">
														<label for="exampleInputNumber">會員編號:</label>
														<input type="text" class="form-control" id="exampleInputnumber" name="userNum">
													</div><br>
													<div class="form-group">
						...
						<div class="tab-pane fade" id="list-goods" role="tabpanel" aria-labelledby="list-goods-list">
							...
							<!-- Modal7 -->
							<form  name="form1" method="POST" action="newPro.jsp">
							...
							<!-- Modal8 -->
							<form  name="form1" method="POST" action="DelPro.jsp">
							...
							<!-- Modal9 -->
							<form  name="form1" method="POST" action="changePro.jsp">
						...
						<div class="tab-pane fade" id="list-order" role="tabpanel" aria-labelledby="list-order-list">
							...
							<!-- Modal10 -->
							<form  name="form1" method="POST" action="newOr.jsp">
